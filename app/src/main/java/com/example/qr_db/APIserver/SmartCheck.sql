...
-- Started on 2026-06-07 02:12:39

\restrict qCq0bZj8TNVYqLHpnVnPkYdgw6LLIfgUbEZPuOsfBN89oPP2isajibHIgfPFzgm
...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ViEn2zSdf/ix+KOIIEk0qA==$bU7jzCf49v9ZDgBLQmLqTT6+NY2w7/zTdGnWNBiroC0=:DsZ6Cm5poEeqRrqEoXlV6eLpX/kndWdMyGwmNM7Wou0=';
...
\unrestrict qCq0bZj8TNVYqLHpnVnPkYdgw6LLIfgUbEZPuOsfBN89oPP2isajibHIgfPFzgm
...
\restrict 66GXa3VF2fPwhqipJobYbcyvEEG0dEBuJf9lRwC22KraZjRcC58vtHJjYtA2CG9
...
-- Completed on 2026-06-07 02:12:39

--
-- PostgreSQL database dump complete
--

\unrestrict 66GXa3VF2fPwhqipJobYbcyvEEG0dEBuJf9lRwC22KraZjRcC58vtHJjYtA2CG9

--
-- Database "SmartCheck" dump
--
...
\restrict aGdKfA9wd7aEckwoUAmhQNcEfaxh4id4ngJR7mCEZPQTJ5Cv0xkLZQLaxruBshX

-- Dumped from database version 18.3
-- Dumped by pg_dump version 18.1

-- Started on 2026-06-07 02:12:40
...
--
-- TOC entry 5096 (class 1262 OID 16388)
-- Name: SmartCheck; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "SmartCheck" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Russian_Russia.1251';


ALTER DATABASE "SmartCheck" OWNER TO postgres;

\unrestrict aGdKfA9wd7aEckwoUAmhQNcEfaxh4id4ngJR7mCEZPQTJ5Cv0xkLZQLaxruBshX
\connect "SmartCheck"
\restrict aGdKfA9wd7aEckwoUAmhQNcEfaxh4id4ngJR7mCEZPQTJ5Cv0xkLZQLaxruBshX
...
--
-- TOC entry 5090 (class 0 OID 16511)
-- Dependencies: 232
...
--
-- TOC entry 5082 (class 0 OID 16420)
-- Dependencies: 224
...
--
-- TOC entry 5086 (class 0 OID 16453)
-- Dependencies: 228
-- Data for Name: lessons; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.lessons (lesson_id, teacher_id, group_id, subject, start_time, end_time, room) FROM stdin;
\.
...
--
-- TOC entry 5088 (class 0 OID 16491)
-- Dependencies: 230
...
--
-- TOC entry 5080 (class 0 OID 16400)
-- Dependencies: 222
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.users (user_id, full_name, email, password_hash, role_id, created_at, group_id) FROM stdin;
1	Учитель1	techer1@test.com	$2b$10$U2TWFEazZXaNNUeufz5MSumi2/EeTJJcYlgWcfsbGMxFOXdxAu9M2	2	2026-05-31 15:39:12.413957	\N
2	Учитель2	techer2@test.com	$2b$10$tAWctlYy6pLY6X.HdIMp3OW0QNqIzGCOoDltZIhx3k2XAwkKEF2Jq	2	2026-05-31 15:39:17.741713	\N
3	Учитель3	techer3@test.com	$2b$10$3tHhjQqpoNgJtII0ex6CUOVO7vawPS8IPYTJMgU/.XumEU0GQoQmK	2	2026-05-31 15:39:22.571824	\N
4	Сис-админ	admin@test.com	$2b$10$9OS0rXxxIdXk7P9h5Hy85.IEvknqMz0lPKJqEhifUFW65pHDuZKOC	3	2026-05-31 15:39:45.786941	\N
5	Администрация	dep@test.com	$2b$10$mR/XJZnZU73Zh1p1CCimGeo0n2mQcx0U4EFfcBNkzn3V4cfIt9NAC	4	2026-05-31 15:40:06.118706	\N
\.
...
--
-- TOC entry 4929 (class 2606 OID 16525)
...
--
-- TOC entry 4924 (class 2606 OID 16447)
...
--
-- TOC entry 4922 (class 2606 OID 16429)
...
--
-- TOC entry 4927 (class 2606 OID 16503)
...
--
-- TOC entry 4920 (class 2606 OID 16656)
...
-- Completed on 2026-06-07 02:12:40
...
\restrict 9ib8mvfhGwr3PtYBaV30xaEJcB6oHJw3SHN2VbvI4ZWwF3fhGPfx9kTwNx2oN3W
...
\unrestrict 9ib8mvfhGwr3PtYBaV30xaEJcB6oHJw3SHN2VbvI4ZWwF3fhGPfx9kTwNx2oN3W
